...
Read related ADRs and the current callers/tests before editing.

## 2. Environment

Requirements are Node.js `>= 22.19.0`, npm, Git, and Bash on Windows. Native TUI work also requires Visual Studio C++
...
DSH is pinned to `0.1.0-rc.6`. Use current package types, Harness source, ApiProxy, events, and real Runtime probes as
evidence.
...
Put durable product and public terminology decisions in ADRs, and complex evidence chains in
