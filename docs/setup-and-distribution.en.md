...
| Dual Windows x64 installers | `SUPPORTED` | [`v0.1.0-preview.5`](https://github.com/Slapq/MetaPi/releases/tag/v0.1.0-preview.5) provides bundled-Node and system-Node variants |
