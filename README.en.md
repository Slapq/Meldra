...
| [`MetaPi-Setup.exe`](https://github.com/Slapq/MetaPi/releases/tag/v0.1.0-preview.4) | `SUPPORTED` | Windows x64; includes Node.js and portable Windows Terminal |
| [`MetaPi-Setup-NodeJS.exe`](https://github.com/Slapq/MetaPi/releases/tag/v0.1.0-preview.4) | `SUPPORTED` | Windows x64; uses existing Node.js and warns without blocking installation when it is absent or old |
