...
const updateConfig = pkg.piConfig?.update;
const defaultUpdateUrl = piConfigName ? undefined : "https://pi.dev/api/latest-version";
const defaultChangelogUrl = piConfigName ? undefined : "https://pi.dev/changelog";
export const PACKAGE_NAME: string = pkg.name || "@earendil-works/pi-coding-agent";
export const APP_NAME: string = piConfigName || "pi";
export const APP_TITLE: string = piConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".pi";
export const VERSION: string = pkg.version || "0.0.0";
export const SELF_UPDATE_ENABLED: boolean = updateConfig?.enabled ?? !piConfigName;
export const VERSION_CHECK_URL: string | undefined = SELF_UPDATE_ENABLED
	? updateConfig?.versionCheckUrl || defaultUpdateUrl
	: undefined;
export const CHANGELOG_URL: string | undefined = SELF_UPDATE_ENABLED
	? updateConfig?.changelogUrl || defaultChangelogUrl
	: undefined;

// e.g., PI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;
export const ENV_SESSION_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_SESSION_DIR`;
export const ENV_AUTH_PATH = `${APP_NAME.toUpperCase()}_AUTH_PATH`;
