...
export interface AppKeybindings {
	...
	"app.message.interruptSend": true;
...
export const KEYBINDINGS = {
	...
	"app.message.interruptSend": {
		defaultKeys: process.platform === "win32" ? "ctrl+shift+enter" : "ctrl+enter",
		description: "Abort current turn and send message",
	},
	"app.message.dequeue": {
		defaultKeys: "alt+up",
