...
export interface ExtensionUIContext {
	...
	/** Show a masked text input dialog for write-only secrets. */
	secretInput(title: string, placeholder?: string, opts?: ExtensionUIDialogOptions): Promise<string | undefined>;
	...
	/** Replace the complete editor draft. Returns false when this UI cannot preserve images. */
	setEditorDraft(draft: EditorDraft): boolean;

	/** Read the complete editor draft, or undefined when this UI cannot expose it synchronously. */
	getEditorDraft(): EditorDraft | undefined;
...
export interface ExtensionCommandContext extends ExtensionContext {
	...
	/**
	 * Execute an available slash command through the current host and wait for its
	 * existing handler semantics to complete. Returns false when the command is
	 * unavailable in this mode; unknown input is never sent to the model.
	 */
...
export interface ExtensionContextActions {
	getProfileRuntime: () => ProfileAgentRuntime | undefined;
	getModel: () => Model<any> | undefined;
	/** Persist a provider/model preference for the current Profile. */
	setModelPreference?: (provider: string, modelId: string) => void;
