...
import { APP_NAME, CONFIG_DIR_NAME, ENV_AGENT_DIR, ENV_SESSION_DIR, SELF_UPDATE_ENABLED } from "../config.ts";
...
${chalk.bold("Commands:")}
  ${APP_NAME} setup [options]             Install or restore the MetaPi Starter Profile
  ${APP_NAME} profile <command>          Manage MetaPi Profiles
  ${APP_NAME} init                       Create .pi/metapi.json explicitly
  ${APP_NAME} install <source> [-l]     Install extension source and add to settings
  ${APP_NAME} remove <source> [-l]      Remove extension source from settings
  ${APP_NAME} uninstall <source> [-l]   Alias for remove
  ${APP_NAME} update [source|self|pi]   ${SELF_UPDATE_ENABLED ? `Update ${APP_NAME}, extensions, or model catalogs` : `Update extensions or model catalogs (${APP_NAME} self-update disabled)`}
...
${chalk.bold("Options:")}
  --profile <name>               MetaPi Profile (default: session, directory binding, then default)
